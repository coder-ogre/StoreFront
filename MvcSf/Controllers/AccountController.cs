...
namespace MvcSf.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            //stuff I added
            var userQuery = (from uq in db.UserTable.Where(uq => uq.UserName == System.Web.HttpContext.Current.User.Identity.Name) select uq).FirstOrDefault();
            ...
            if (!(matchCartToUserQuery == null))
            {
                ...
                foreach (var item in matchCartItemToCart.ToList())
                {
